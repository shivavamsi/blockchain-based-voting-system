...
public class Simulation{
   ...
   public static void main(String[] args){
      ...
      HashMap<Integer, String> validTxs = new HashMap<Integer, String>();
      int numTx = 500;
      String pkToBase58;
      HashSet<Integer> validTxIds = new HashSet<Integer>();
      HashSet<BigInteger> TxPks = new HashSet<BigInteger>(); 
      ...
      for (int i = 0; i < numNodes; i++){
         ...
         for(Integer txID : validTxIds){
            ...
            if (Math.random() < p_txDistribution) // p_txDistribution is .01, .05, or .10. 
               pendingTransactions.add(new Transaction(script, txID, validTxs.get(txID)));
         }
      ...
      for (int i = 0; i < numNodes; i++){
         ...
         System.out.println("Transactions that Node " + i + " believes consensus on:");
         for (Transaction tx : transactions)
            System.out.println(tx.script + "\t: " + tx.address);
         System.out.println();
         System.out.println();
      }
   }
